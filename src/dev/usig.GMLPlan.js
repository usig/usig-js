 ...
 */
usig.GMLPlan = OpenLayers.Class(OpenLayers.Layer.Vector, {
	...
	initialize: function(name, options) {
        var newArguments = [];
        this.styleMap = this.getStyle(options.template);
    ...
    getStyle: function(template) {
			...
			if(template.marker != undefined) {
   		    	externalGraphic = "images/" + template.marker;
   		    } else {
			...
			var lookup = {
			    "walk": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,externalGraphic:"images/recorrido_pie.png",graphicZIndex:5}, 
					"Line": lineOptionsWalk },
			    "bus": {"Point": {pointRadius: 12, externalGraphic:"images/recorrido_colectivo.png",graphicWidth:35, graphicHeight:35,graphicZIndex:5}, "Line": lineOptions  },
			    "car": {"Point": {externalGraphic:"images/recorrido_auto.png",graphicWidth:35, graphicHeight:35,graphicZIndex:5}, "Line": lineOptions  },
			    "subway": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/recorrido_subte.png",graphicZIndex:5}, "Line": lineOptions  },
			    "subwayA": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/lineasubte41x41-a.png",graphicZIndex:5}, "Line": lineOptions  },
			    "subwayB": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/lineasubte41x41-b.png",graphicZIndex:5}, "Line": lineOptions  },
			    "subwayC": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/lineasubte41x41-c.png",graphicZIndex:5}, "Line": lineOptions  },
			    "subwayD": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/lineasubte41x41-d.png",graphicZIndex:5}, "Line": lineOptions  },
			    "subwayE": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/lineasubte41x41-e.png",graphicZIndex:5}, "Line": lineOptions  },
				"subwayH": {"Point": {pointRadius: 12, graphicWidth:35, graphicHeight:35,
					externalGraphic:"images/lineasubte41x41-h.png",graphicZIndex:5}, "Line": lineOptions  },
		    	...
		    	//externalGraphic:"images/recorrido_subte.png"}, "Line": lineOptions},
	   		    ...
	   		    "train": {"Point": {pointRadius: 12, externalGraphic:"images/recorrido_tren.png",graphicWidth:35, graphicHeight:35},graphicZIndex:5, "Line": lineOptions  },
