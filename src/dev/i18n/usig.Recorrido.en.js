usig.Recorrido.defaults.texts = {
		...
		planTransporte: {
				...
				'startCruce':{texto: 'Walk from intersection of <span class="plan-calle">$esquina</span>'},
				'finish':{texto: ' until reach your destination.'}},
				'board':{'walking':{texto: ' up to intersection of <span class="plan-calle">$esquina</span>'},
    			'walkingestacion':{texto: ' up to the <span class="plan-estacion">$estacion station</span> at intersection of <span class="plan-calle">$esquina</span>'},
    			...
    			'esquina': {texto: ' at intersection of <span class="plan-calle">$esquina</span>'},
		        ...
		        'cole':{texto: ' get off at <span class="plan-calle">$esquina</span>'},
		        'metrobus':{texto: ' get off at <span class="plan-estacion">$estacion station</span> at <span class="plan-calle">$esquina</span>'}},
