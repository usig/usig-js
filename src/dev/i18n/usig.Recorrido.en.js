usig.Recorrido.texts['en'] = {
		...
		planTransporte: {
				...
				'board':{'walking_esquina':{texto: ' up to intersection of <span class="plan-calle">$calle1 and $calle2</span>'},
						'walking_calle_nro':{texto: ' up to <span class="plan-calle">$nro $calle1</span>'},
						...
						'calle_nro': {texto: ' at <span class="plan-calle">$nro $calle1</span>'},
				...
				'alight':{'subtetren':{texto: ' and exit at <span class="plan-estacion">$estacion station</span>'},
						'cole_esquina':{texto: ' get off at <span class="plan-calle">$calle1 and $calle2</span>'},
						'cole_calle_nro':{texto: ' get off at <span class="plan-calle">$nro $calle1</span>'},
