usig.Recorrido.texts['es'] = {
		...
		planTransporte: {
            ...
            'board':{'walking_esquina':{texto: ' hasta <span class="plan-calle">$calle1 y $calle2</span>'},
            			'walking_calle_nro':{texto: ' hasta <span class="plan-calle">$calle1 $nro </span>'},
            			...
            			'calle_nro': {texto: ' en <span class="plan-calle">$calle1 $nro</span>'},
            ...
            'alight':{'subtetren':{texto: ' y bajar en la estación <span class="plan-estacion">$estacion</span>'},
	 		        	'cole_esquina':{texto: ' y bajar en <span class="plan-calle">$calle1 y $calle2</span>'},
	 		        	'cole_calle_nro':{texto: ' y bajar en <span class="plan-calle">$calle1 $nro</span>'},
